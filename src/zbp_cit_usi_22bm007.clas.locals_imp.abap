...
CLASS lhc_User IMPLEMENTATION.
  ...
  METHOD uploadExcelData.
    ...
    READ ENTITIES OF zcit_usi_22bm007 IN LOCAL MODE
    ...
    " 2. Parse Excel
    DATA: lt_excel_temp TYPE STANDARD TABLE OF zbp_cit_usi_22bm007=>gty_exl_file.
    ...
    MODIFY ENTITIES OF zcit_usi_22bm007 IN LOCAL MODE
  ...
  METHOD downloadexcel.
    DATA: lt_template TYPE STANDARD TABLE OF zbp_cit_usi_22bm007=>gty_exl_file.
    ...
    READ ENTITIES OF zcit_usi_22bm007 IN LOCAL MODE ENTITY User ALL FIELDS WITH CORRESPONDING #( keys ) RESULT DATA(lt_u).
  ...
  METHOD FillSelectedStatus.
    READ ENTITIES OF zcit_usi_22bm007 IN LOCAL MODE ENTITY User FIELDS ( Attachment ) WITH CORRESPONDING #( keys ) RESULT DATA(lt_u).
    MODIFY ENTITIES OF zcit_usi_22bm007 IN LOCAL MODE
      ENTITY User UPDATE FIELDS ( FileStatus )
